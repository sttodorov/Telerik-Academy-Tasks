namespace NewsSystem.WebForms.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewsSystem.WebForms.Data.NewsSystemDbContext>
    {
        ...
        protected override void Seed(NewsSystem.WebForms.Data.NewsSystemDbContext context)
        {
            if (!context.Users.Any())
            {
                var userManager = new ApplicationUserManager(new UserStore<ApplicationUser>(context));

                var anonymus = new ApplicationUser() { UserName = "anonymus@news.com", Email = "anonymus@news.com" };
                userManager.Create(anonymus, "123456");
            }
            if (!context.Categories.Any())
            {
                context.Categories.Add(new Category() { Name = "Art" });
                ...
                context.Categories.Add(new Category() { Name = "Science" });
                context.Categories.Add(new Category() { Name = "Weather" });
                context.SaveChanges();
            }
            if (!context.Articles.Any())
            {
                ...
                var anonymus = context.Users.FirstOrDefault(u => u.UserName == "anonymus@news.com");
